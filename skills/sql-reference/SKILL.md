...
name: sql-reference
description: |
  Use when the user asks about SQL in FileMaker — ExecuteSQL function syntax,
  ODBC/JDBC SQL queries, supported SQL statements (SELECT, INSERT, UPDATE,
  DELETE), data types, reserved words, SQL expressions.
---
...
1. Read `references/sql-reference.md` to find the relevant page URL(s) for the user's question.
